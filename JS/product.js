...
//             data = resp.data;
//             data.forEach(e => {
//                 console.log(`${e.first_name}, ${e.last_name}, ${e.address}`);
//             });
//         })
//         .catch(error => {
//             console.log(error);
        ...
        <div class="produre_box bg-white shadow-sm ">										
            <div class="image_box imgs" >										
                ...
                <div class="info_box p-3 bg-white ">										
                    <p class="float-left font-weight-bold mb-0 text-center" style="font-size: 70%;color:white; "><b>` + data.name + `</b></p><p class="float-left font-weight-bold mb-2 text-center" style="font-size: 70%;"><b>` + data.price + `đ</b></p>									
        ...
        var prinf =
            ...
            <div class="produre_box bg-white shadow-sm ">										
                <div class="image_box imgs">										
                    ...
                    <div class="info_box p-3 bg-white ">										
                        <p class="float-left font-weight-bold mb-0 text-center" style="font-size: 70%"><b>` + data.name + `</b></p>
                        <span style="float:left; font-size: 70%"><strike> <b>` + data.price + `đ</b></strike> </span>
                        <p class=" font-weight-bold mb-2" style="font-size: 70%;float:right"><b>` + data.price + `đ</b></p>									
                            <div style="clear: both;"></div>										
